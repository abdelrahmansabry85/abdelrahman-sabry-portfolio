...
const projects: Project[] = [
  ...
  {
    number: '03', label: 'INTERACTIVE EXPERIENCE / WEB APP', title: 'Birthday Experience Website',
    description: 'A cinematic birthday experience: an animated photo journey, a synced music player, floating balloons, and a bilingual personal letter, told as one flowing story.',
    stack: ['React 19', 'TypeScript', 'Tailwind CSS 4', 'Motion', 'Vite'], url: 'https://abdelrahmansabry85.github.io/birthday-website-template/',
    thumbnail: '/birthday-template.png', screenshots: ['/birthday-template.png'],
    problem: 'A birthday site has to feel warm and personal — a plain page with a greeting does not create a moment.',
    decisions: 'Built the visit as a five-phase story: an intro gate, timed photo slides, a typography moment, a letter view, and a finale — with one music engine kept in sync across every phase.',
    role: 'Design · Front-end development',
    outcome: 'A smooth, mobile-friendly experience with cinematic transitions, an interactive filmstrip, and an Arabic/English letter toggle.',
    details: 'React 19 and Motion power the phase transitions, Ken Burns-style image presentation, and the floating balloon physics, while Tailwind CSS 4 handles the editorial light theme. Music starts on first interaction through a YouTube/local fallback chain with a floating playback controller, and prefers-reduced-motion is respected throughout.',
  },
]
...
function Footer() {
  return <footer className="site-footer"><div className="page-shell"><div className="footer-top"><Brand /><span>Front-end engineer<br />with a data mindset.</span><div className="footer-links" aria-label="Social and contact links"><a className="footer-social-link" href="mailto:mobodymo6@gmail.com" aria-label="Email Abdelrahman" title="Email"><FaEnvelope /></a><a className="footer-social-link" href="https://wa.me/201553258929" target="_blank" rel="noreferrer" aria-label="Message Abdelrahman on WhatsApp" title="WhatsApp"><FaWhatsapp /></a><a className="footer-social-link" href="https://www.linkedin.com/in/abdelrahman-sabry-b36500275/" target="_blank" rel="noreferrer" aria-label="Abdelrahman on LinkedIn" title="LinkedIn"><FaLinkedinIn /></a><a className="footer-social-link" href="https://x.com/abosabrynbo?s=11" target="_blank" rel="noreferrer" aria-label="Abdelrahman on X" title="X"><FaXTwitter /></a><a className="footer-social-link" href="https://github.com/abdelrahmansabry85" target="_blank" rel="noreferrer" aria-label="Abdelrahman on GitHub" title="GitHub"><FaGithub /></a></div></div><div className="footer-bottom"><span>© 2026 Abdelrahman Sabry</span><a href="#top">Back to top</a><span>Built with React + TypeScript</span></div></div></footer>
}
